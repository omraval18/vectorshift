...
import { File, Folder, Globe, Link, Sheet, Speaker, Video } from "lucide-react";
...
export function OrbitingCirclesDemo() {
    return (
        <div className="relative flex h-[500px] bg-muted/40 w-5/6 items-center justify-center overflow-hidden rounded-3xl border  md:shadow-xl">
            ...
            {/* Inner Circles */}
            <OrbitingCircles
                className="h-[30px] w-[30px] border-none backdrop-blur-3xl -webkit-backdrop-blur-lg"
                duration={20}
                delay={20}
                radius={80}
            >
            ...
            <OrbitingCircles
                className="h-[40px] w-[40px] border-none backdrop-blur-3xl -webkit-backdrop-blur-lg"
                duration={20}
                delay={10}
                radius={140}
                reverse
            >
                <Sheet className="size-5" strokeWidth={1.5} />
            </OrbitingCircles>
            <OrbitingCircles
                className="h-[40px] w-[40px] border-none backdrop-blur-3xl -webkit-backdrop-blur-lg"
                radius={140}
            ...
            <OrbitingCircles
                className="h-[50px] w-[50px] border-none backdrop-blur-3xl -webkit-backdrop-blur-lg"
                radius={190}
                duration={20}
            >
