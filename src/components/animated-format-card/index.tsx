...
import { Folder, Globe, Sheet, Speaker, Video } from "lucide-react";
import { SpeakerLoudIcon } from "@radix-ui/react-icons";

export function AnimatedFormatCard() {
    return (
        <Card>
            <CardSkeletonContainer>
                <Skeleton />
            </CardSkeletonContainer>
            <CardTitle>Give Super Powers to All Data</CardTitle>
            <CardDescription>
               You can leverage AI across data formates like documents, videos, audio files, and
                websites.
            </CardDescription>
        </Card>
    );
        ...
        <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
            <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
                ...
                <Container className="h-12 w-12 circle-2">
                    <Folder className="h-6 w-6 dark:text-white" />
                </Container>
                <Container className="circle-3">
                    <SpeakerLoudIcon className="h-8 w-8 dark:text-white" />
                </Container>
